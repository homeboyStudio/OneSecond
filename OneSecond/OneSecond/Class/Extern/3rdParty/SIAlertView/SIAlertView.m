...
{
    [super viewDidLoad];
//    [[SIAlertView appearance] setMessageFont:[OSFont customFontWithSize:ExplanatoryFontSize]];
//    [[SIAlertView appearance] setTitleFont:[OSFont customFontWithSize:TableTitleFontSize]];
//    
//    [[SIAlertView appearance] setTitleColor:[OSColor pureDarkColor]];
//    [[SIAlertView appearance] setMessageColor:[OSColor specialGaryColor]];
//    
//    [[SIAlertView appearance] setCornerRadius:10];
//    [[SIAlertView appearance] setShadowRadius:5];
//    
//    [[SIAlertView appearance] setViewBackgroundColor:[OSColor pureWhiteColor]];
//    
//    [[SIAlertView appearance] setButtonColor:[OSColor pureWhiteColor]];
//    [[SIAlertView appearance] setCancelButtonColor:[OSColor pureWhiteColor]];
//    
//    [[SIAlertView appearance] setDefaultButtonImage:[UIImage imageFromColor:[OSColor skyBlueColor]] forState:UIControlStateNormal];
//    [[SIAlertView appearance] setDefaultButtonImage:[UIImage imageFromColor:[OSColor skyBlueColor]] forState:UIControlStateHighlighted];
//    
//    [[SIAlertView appearance] setCancelButtonImage:[UIImage imageFromColor:[OSColor specialorangColor]] forState:UIControlStateNormal];
//    [[SIAlertView  appearance] setCancelButtonImage:[UIImage imageFromColor:[OSColor specialorangColor]] forState:UIControlStateHighlighted];
...
+ (void)initialize
{
    ...
    appearance.viewBackgroundColor = [OSColor pureWhiteColor];
    
    appearance.titleColor = [OSColor pureDarkColor];
    appearance.messageColor = [OSColor specialGaryColor];
    
    appearance.titleFont = [OSFont nextDayFontWithSize:TableTitleFontSize];
    appearance.messageFont = [OSFont nextDayFontWithSize:ExplanatoryFontSize];
    
    appearance.buttonFont = [OSFont nextDayFontWithSize:ButtonNavFontSize];
    
    appearance.buttonColor = [OSColor pureWhiteColor];
    appearance.cancelButtonColor = [OSColor pureWhiteColor];
      
    [appearance setDefaultButtonImage:[UIImage imageFromColor:[OSColor skyBlueColor]] forState:UIControlStateNormal];
    [appearance setDefaultButtonImage:[UIImage imageFromColor:[OSColor skyBlueColor]] forState:UIControlStateHighlighted];
      
    [appearance setCancelButtonImage:[UIImage imageFromColor:[OSColor specialorangColor]] forState:UIControlStateNormal];
    [appearance setCancelButtonImage:[UIImage imageFromColor:[OSColor specialorangColor]] forState:UIControlStateHighlighted];
